...
[![Austin Metro](https://img.shields.io/badge/coverage-Austin%20MSA-orange)](#tools-41-live)
...
| `austin_commute` | Composed: drive time + distance between two addresses. Key-free 3-tier routing (OSRM demo → Valhalla demo → straight-line estimate) so it never hard-fails. No real-time traffic. |
